  ...
  try {
    ...
    await NikahBooking.insertMany([
      ...
      },
      {
        ...
        ceremonyDate: new Date('2026-09-20'),
        ceremonyTime: '12:00',
        phone: '0302-8883344',
        email: 'faisal.iqbal@example.com',
        address: 'Block B, Samanabad, Sheikhupura',
        status: 'pending',
        userId: user3._id,
      ...
      },
      {
        ...
        ceremonyDate: new Date('2026-09-28'),
        ceremonyTime: '13:00',
        phone: '0302-9995566',
        email: 'imran.younas@example.com',
        address: '15-A Model Town, Sheikhupura',
        status: 'pending',
        userId: user4._id,
